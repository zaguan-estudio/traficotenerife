...
const CAMERA_GROUPS = [
     ...
     53 cámaras                                            */
  {
    ...
    cameras: [
      ...
      { id: '2701001-41',  name: 'Guajara'               },
      { id: '2701002-514', name: 'Norte · 14'          },
      { id: '2701002-131', name: 'Norte · 15'          },
      { id: '2701001-70',  name: 'Norte · 16'          },
      { id: '2701002-516', name: 'Padre Anchieta'        },
      { id: '2701002-517', name: 'TF-5 · pk B1'        },
      { id: '2701002-519', name: 'Padre Anchieta túnel'  },
      { id: '2701002-520', name: 'San Benito KFC 1'      },
      { id: '2701002-521', name: 'San Benito KFC'        },
